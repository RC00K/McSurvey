...
const Review: React.FC = () => {
    ...
    return (
        <IonPage>
            <IonContent>
                <main className="main">
                    <section className="section" id="review-header">
                        <div className="container">
                            <div className="review__header__content">
                                <button className="back__btn" onClick={handleBackToSurvey}>
                                    <IonIcon icon={chevronBack} />
                                </button>
                                <div className="review__header__upper">
                                    <div>
                                        <h1 className="review__header__title">
                                            AOT green fees <span>survey</span>
                                        </h1>
                                        <p className="review__header__description">
                                            Review your answers before submitting.
                                        </p>
                                    </div>
                                </div>
                                <svg className="review__header__svg" viewBox="0 0 1160 400" preserveAspectRatio="none">
                                    <defs>
